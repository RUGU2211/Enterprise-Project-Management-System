...
VALUES ('admin', '$2a$10$0OYzRzNGWnMEfVeCHnRC0uMx6jB2zH3Zl9yfsjdkOIzYbuJPyIMcW', 'admin@example.com', 'System Administrator', TRUE);
...
-- -----------------------------------------------------
INSERT INTO `users` (`username`, `password`, `email`, `full_name`, `is_enabled`) 
VALUES ('manager', '$2a$10$AkdJRi7TUl0EYJ1miXgqFeLuqU7XcX2OMtJc52.GHRQEd8LBOKJbq', 'manager@example.com', 'Project Manager', TRUE);
...
-- -----------------------------------------------------
INSERT INTO `users` (`username`, `password`, `email`, `full_name`, `is_enabled`) 
VALUES ('dev', '$2a$10$KPzBTY/CzhcA5eOVTyvdFeFvTuAGjKTcIhkOmRiLbUXoMbO7XCF1K', 'dev@example.com', 'Developer', TRUE);
